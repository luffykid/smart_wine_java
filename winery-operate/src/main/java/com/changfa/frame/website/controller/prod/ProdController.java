...
public class ProdController {
    ...
    public String addProd(@RequestBody AddProdDTO addProdDTO, List<Integer> wineryList) {
        try {
            log.info("添加商品:addProdDTO:" + addProdDTO);
            AdminUser adminUser = adminUserService.findAdminUserByToken2(addProdDTO.getToken());
            ...
            if (adminUser == null) {
                ...
                prodService.addOperateProd(adminUser, addProdDTO,wineryList);
    ...
    public String updateProd(@RequestBody AddProdDTO addProdDTO, List<Integer> wineryList) {
        try {
            ...
            if (adminUser == null) {
                ...
                prodService.updateOperateProd(adminUser, addProdDTO, wineryList);
