...
import com.changfa.frame.core.util.ByteUtil;
...
public class RedisClient {
    ...
    public JedisPool checkConnectionPool() {
        if (jedisPool == null) {
            synchronized (lock) {
                if (jedisPool == null) {
                    try {
                        jedisPool = new JedisPool(jedisPoolConfig, host, port, timeout, productPassword);
                    } catch (Exception e) {
                        logger.error("[校验JedisPoll连接池失败]" + ExceptionUtils.getFullStackTrace(e));
                    }
                }
            }
        }
    ...
    public void releaseJedisInstance(Jedis jedis) {
        try {
            ...
            logger.error("[释放Jedis实例失败]" + ExceptionUtils.getFullStackTrace(e));
        }
    ...
    public boolean set(Object key, Object value) {
        ...
        try {
            ...
            logger.error("[Redi数据存储失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
    ...
    public boolean setAndExpire(Object key, Object value, int expire) {
        ...
        try {
            ...
            logger.error("[设置byte类型的KEY有效时间出错]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        return false;
    ...
    public Object get(Object key) {
        ...
        try {
            ...
            logger.error("[获取byte类型key的value值出错]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public boolean expire(Object key, int expire) {
        ...
        try {
            ...
            logger.error("[设置byte类型的KEY缓存有效时间失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        return false;
    ...
    public boolean del(Object key) {
        ...
        try {
            ...
            logger.error("[删除byte类型的key失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        return false;
    ...
    public boolean exists(Object key) {
        ...
        try {
            ...
            logger.error("[判断缓存是否存在出错]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        return false;
    ...
    public void setStringForObject(String key, Object o) {
        ...
        try {
            ...
            logger.error("[存储String类型的KEY，JSON类型的Value失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
    ...
    public void setAndExpireString(String key, String v, int expire) {
        ...
        try {
            ...
            logger.error("[Redis存储数据失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
    ...
    public long setnxAndExpireString(String key, String value, int expire) {
        ...
        try {
            ...
            logger.error("[Redis缓存有效时间数据失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        return result;
    ...
    public <T> T get(String key, TypeReference<T> clazz) {
        ...
        try {
            ...
            logger.error("[根据KEY获取特定类型的缓存值]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        if (json == null) {
    ...
    public <T> T get(String key, Class<T> clazz) {
        ...
        try {
            ...
            logger.error("[根据KEY获取指定类型的缓存值失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        if (json == null) {
    ...
    public Set<String> smembers(String key) {
        ...
        try {
            ...
            logger.error("[返回集合中的所有的成员失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Long srem(String key, String member) {
        ...
        try {
            ...
            logger.error("[移除集合中的一个或多个成员元素，不存在的成员元素会被忽略失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public String spop(String key) {
        ...
        try {
            ...
            logger.error("[移除并返回集合中的一个随机元素失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public List<String> srandmember(String key, int count) {
        ...
        try {
            ...
            logger.error("[返回集合中一个或多个随机元素]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Long srem(String key, List<String> members) {
        ...
        try {
            ...
            logger.error("[移除集合中一个或多个成员出错：]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Boolean sismember(String key, String member) {
        ...
        try {
            ...
            logger.error("[判断 member 元素是否集合 key 的成员失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Long scard(String key) {
        ...
        try {
            ...
            logger.error("[获取存储在集合中的元素的数量失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Long incrBy(String key, long integer) {
        ...
        try {
            ...
            logger.error("[ key 中储存的数字加上指定的增量值失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Long hincrBy(String key, String field, long value) {
        ...
        try {
            ...
            logger.error("[用于增加存储在字段中存储由增量键哈希的数量失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Long decrBy(String key, long num) {
        ...
        try {
            ...
            logger.error("[减小存储在由指定的值的key的数量失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Long zcard(String key) {
        ...
        try {
            ...
            logger.error("[返回在指定的键存储在集合中的元素的数量失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public Set<String> zrange(String key, int start, int end) {
        ...
        try {
            ...
            logger.error("[返回存储在关键的排序元素集合在指定的范围失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public <T> Set<T> zrevrange(String key, Class<T> clazz, int start, int end) {
        ...
        try {
            ...
            logger.error("[返回存储在键的排序元素集合在指定的范围失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
        return result;
    ...
    public Set<String> zrangeByScore(String key, Long min, Long max) {
        ...
        try {
            ...
            logger.error("[返回的有序集合在最小值和最大值(包括得分等于最小或最大元素)之间的分数键中的所有元素失败]" + ExceptionUtils.getFullStackTrace(e));
            return null;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public void zrem(String key, String member) {
        ...
        try {
            ...
            logger.error("[有序集合存储在键删除指定成员失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
    ...
    public void zadd(String key, Long score, String member) {
        ...
        try {
            ...
            logger.error("[添加所有指定的成员指定的分数存放在键的有序集合失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
    ...
    public void zincrBy(String key, Long score, String member) {
        ...
        try {
            ...
            logger.error("[加单位成员的有序集合存储增量键比分失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
    ...
    public void zremrangeByRank(String key, int start, int end) {
        ...
        try {
            ...
            logger.error("[删除的元素数量失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
    ...
    public void zremrangeByScore(String key, Long start, Long end) {
        ...
        try {
            ...
            logger.error("[删除的有序集合保存在key的最小值和最大值(含)之间的分数的所有元素数量失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
    ...
    public int zscore(String key, String member) {
        ...
        try {
            ...
            logger.error("[返回成员的有序集合在键比分失败]" + ExceptionUtils.getFullStackTrace(e));
            return 0;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public int zscore(String key, Object o) {
        ...
        try {
            ...
            logger.error("[返回成员的有序集合键值比分失败]" + ExceptionUtils.getStackTrace(e));
            return 0;
        } finally {
            releaseJedisInstance(jedis);
        }
    ...
    public void flushAll() {
        ...
        try {
            ...
            logger.error("[Cache清空失败]" + ExceptionUtils.getFullStackTrace(e));
        } finally {
            releaseJedisInstance(jedis);
        }
    }
